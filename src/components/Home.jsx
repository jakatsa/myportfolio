            ...
            <div className="col-xxl-8">
              <div className="text-center my-5">
                ...
                <p className="lead fw-light mb-4">
                  My name is Joe Jeremy and I help brands grow.
                </p>
                <p className="text-muted">
                  As a Front-End Developer.I possess an impressive arsenal of
                  skills in JavaScript, WordPress,Figma and React. I thrive in
                  creating and maintaining responsive websites that offer a
                  ...
                  crosss-funcrtional teams to produce outstanding web
                  applications
                </p>
